...
export const setCustomerService = asyncHandler(
  async (req: AuthenticatedRequest, res: ExpressResponse) => {
    ...
    const result =
      await CustomerServiceModel.createCustomerService(customerServiceData);
...
export const updateCustomerService = asyncHandler(
  async (req: AuthenticatedRequest, res: ExpressResponse) => {
    ...
    const customerServiceExists =
      await CustomerServiceModel.getCustomerServiceById(Number(req.params.id));
    ...
    const result =
      await CustomerServiceModel.updateCustomerService(customerServiceData);
